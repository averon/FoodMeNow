...
menu_categories = MenuCategory.create([
  ...
  { name: 'Beef and Lamb', restaurant_id: 2, ord: 6 },
  { name: 'Chicken and Duck', restaurant_id: 2, ord: 7 },
  { name: 'Pork', restaurant_id: 2, ord: 8 },
  { name: 'Noodle and Rice', restaurant_id: 2, ord: 9 }
])
...
menu_items = MenuItem.create([
  ...
  { name: "Orange Chicken", price: 9, menu_category_id: 13, img_path: 'wonderland/orange_chicken.jpg' },
  { name: "Sesame Chicken", price: 9, menu_category_id: 13, img_path: 'wonderland/sesame_chicken.jpg' },
  { name: "Cashew Chicken", price: 9, menu_category_id: 13, img_path: 'wonderland/cashew_chicken.jpg' },
  { name: "Sweet and Sour Pork", price: 9, menu_category_id: 14, img_path: 'wonderland/sweet_and_sour_pork.jpg' },
  { name: "Salt and Pepper Pork", price: 9, menu_category_id: 15, img_path: 'wonderland/salt_and_pepper_pork.jpg' },
  { name: "Chow Mein", price: 8, menu_category_id: 16, img_path: 'wonderland/chow_mein.jpg' },
  { name: "Chow Fun", price: 8, menu_category_id: 16, img_path: 'wonderland/chow_fun.jpg' },
  { name: "Fried Rice", price: 8, menu_category_id: 16, img_path: 'wonderland/fried_rice.jpg' },
  { name: "Brown Rice", price: 2, menu_category_id: 16, img_path: 'wonderland/brown_rice.jpg' },
  { name: "White Rice", price: 1, menu_category_id: 16, img_path: 'wonderland/white_rice.png' },
])
